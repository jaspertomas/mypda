...
public class CategoryType {
    //------------FIELDS-----------
    public static final String tablename="category_types";
    //field names
...
//	}
    ...
    public void delete()
    {
            CategoryTypes.delete(this);
    }
    public void save()
    {
            if(id==null || id==0)
                    id=CategoryTypes.insert(this);
            else
                    CategoryTypes.update(this);
    }
    @Override
